...
class Sewa(models.Model):
    ...
    tujuan = models.CharField(max_length=240, null=True,blank=False)
    waktu = models.CharField(max_length=240, null=True,blank=False)
    sewa = models.CharField(max_length=240, null=True,blank=False)
